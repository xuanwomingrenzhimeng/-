    ...
    b.fn.fullpage = function(c) {
        ...
        function M() {
            ...
            b(".section").each(function() {
                ...
                c.verticalCentered && b(this).find(".tableCell").css("height", "100%");
        ...
        function w(a) {
            ...
            d = a.find(".scrollable"); (d.length ? a.find(".scrollable").get(0).scrollHeight - parseInt(b.css("padding-bottom")) - parseInt(b.css("padding-top")) : a.get(0).scrollHeight - parseInt(b.css("padding-bottom")) - parseInt(b.css("padding-top"))) > g ? (b = g - parseInt(b.css("padding-bottom")) - parseInt(b.css("padding-top")), d.length ? d.css("height", "100%").parent().css("height", "100%") : (c.verticalCentered ? a.find(".tableCell").wrapInner('<div class="scrollable" />') : a.wrapInner('<div class="scrollable" />'), a.find(".scrollable").slimScroll({
                height: "100%",
                size: "10px",
                alwaysVisible: !0
        ...
        function N(a) {
            a.addClass("table").wrapInner('<div class="tableCell" style="height:100%;" />')
        }
        function z(a, c) {
        ...
        if (c.navigation) {
            b("body").append('<div id="fullPage-nav" style="display:none;"><ul></ul></div>');
        ...
        b(".section").each(function(a) {
            ...
            b(this).css("height", "100%"); (c.paddingTop || c.paddingBottom) && b(this).css("padding", c.paddingTop + " 0 " + c.paddingBottom + " 0");
